      ...
      <div className='flex flex-row-2'>
        <div className='grid-flow-col'>
          ...
          <div className='card mr-20 mt-4'>
            <h3>How To...</h3>
            <p className='w-64' >Fill out the meal that you want, click the date on the Calendar for when you want the meal to show up on the Home page and when you're done click the Confirm Button.</p>
            <p className='w-64'>Put a comma (",") after each ingredient and recipe instruction.</p>
          </div>

          {/* Name */}
          <div className='grid justify-center items-center mr-20 mt-8'>
            <h1 className="text-center">Write the name of the meal</h1>
            <textarea value={name} onChange={(event) => setName(event.target.value)} className='card w-80 h-12 text-center' />
          </div>

          {/* Ingredients */}
          <div className='grid mr-20 mt-4  '>
            <h1 className='text-center'>Write you ingredients here</h1>
            <textarea value={ingredients} onChange={(event) => setIngredients(event.target.value)} className='card-textarea w-80 h-96 justify-start' />
          </div>
        ...
        <div className='grid-flow-col-dense'>
          ...
          <div className='grid pt-12 justify-items-center'>
            ...
            <textarea value={recipe} onChange={(event) => setRecipe(event.target.value)} className='card-textarea w-80 h-96 ' />
          </div>
        </div>
      </div>
    </main >
